...
export class DetalleProduccionService {
    ...
    async createDetalleProduccion(data: DetalleProduccionDto): Promise<ApiResponse<DetalleProduccionDto>>{
        try {
    ...
    async findAllDetalleProduccion(): Promise<ApiResponse<DetalleProduccionDto[]>>{
        try {
